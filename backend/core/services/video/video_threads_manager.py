...
class VideoThreadsManager(object):
    ...
    def add_thumbs_thread(self, t_thread, video_id):
        ...
        try:
            ...
            LOGGER.info("ThumbsCreatorThread sucessfully added to VideoThreadsManager: [video_id={}]".
                        format(video_id))
    ...
    def stop_and_remove_thumbs_thread(self, video_id):
        ...
        try:
            ...
            LOGGER.info("Sucessfully removed thumbs creator thread from VideoThreadsManager: [video_id={}]".
                    format(video_id))
        except Exception as ex:
